...
<div class="collection-hero">
    <div>
        <h2>The <em>Dining</em><br>Collection</h2>
    </div>
    <p>Gather around pieces crafted to make every meal a moment worth remembering.</p>
</div>
...
<div class="products-wrapper">
    ...
    $conn = getConnection();
    $query = "SELECT * FROM product WHERE cateogry = 'Dining'";
